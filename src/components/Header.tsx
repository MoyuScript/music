...
const NavListItem: React.FC<NavListItemProps> = ({ children, href }) => {
    return (
        <li className="py-2 px-4 pb-0 group/navItem">
            <div className="pb-2 border-b-[1px] group-last/navItem:border-b-0 sm:border-b-0">
            ...
            <div className="absolute right-4 sm:relative group">
                ...
                <ul
                    className={clsx(
                        ...
                        'sm:bg-transparent sm:border-0 sm:shadow-none sm:relative sm:flex-row sm:flex'
                    )}
                >
